...
Main_frame.config(bg="#FFD1DC")
Main_frame.grid(row = 0 ,  column= 1 ,  padx= 55 ,  pady =  10)

# Text Lable 
Text_lable = Label(Main_frame, text = "AI Assistant" , font=("comic Sans ms" ,  14 , "bold" ) , bg = "#B0EACD")
...
text=Text(root , font= ('Courier 10 bold') , bg = "#FFFACD")
...
entry1.place(x=75 , y = 500 , width= 350, height= 30)



# Add a text button1
button1 =  Button(root,  text="ASK" , bg="#FFE5B4" , pady=16 ,  padx=40,  borderwidth=3 , relief=SOLID ,  command=ask)
button1.place(x= 70, y= 575)

# Add a text button2
button2 =  Button(root,  text="Send" , bg="#FFE5B4" , pady=16 ,  padx=40,  borderwidth=3 , relief=SOLID ,  command=User_send)
button2.place(x= 400, y= 575)

# Add a text button3
button3 = Button(root, text="Delete", bg="#FFE5B4" , pady=16 ,  padx=40,  borderwidth=3 , relief=SOLID ,command=delete_text)
